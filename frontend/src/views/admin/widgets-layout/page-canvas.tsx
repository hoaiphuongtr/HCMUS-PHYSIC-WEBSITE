  ...
  return (
    ...
    >
      <div className="w-full max-w-4xl mx-auto py-6 px-4">
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#1a2436] shadow-sm overflow-hidden">
          <div className="bg-slate-100 dark:bg-[#1a2436] border-b border-slate-200 dark:border-slate-800 px-4 py-2 flex items-center gap-2">
            ...
            <div className="flex-1 mx-4">
              <div className="bg-white dark:bg-[#1a2436] rounded-md border border-slate-200 dark:border-slate-800 px-3 py-1 text-[11px] text-slate-400 dark:text-slate-500 text-center">
                ...
                <div key={rowGroup.row}>
                  ...
                  >
                    <div className="absolute -left-1 top-1/2 -translate-y-1/2 opacity-0 group-hover/row:opacity-100 transition-opacity cursor-grab active:cursor-grabbing z-10">
                      <GripVerticalIcon className="w-3.5 h-3.5 text-slate-300 bg-white dark:bg-[#1a2436] rounded shadow-sm p-0.5 border border-slate-200 dark:border-slate-800" />
                    </div>
                      ...
                      {hasSpace && (
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <PlusIcon className="w-5 h-5 text-slate-400 dark:text-slate-500 mx-auto block" />
...
function DropZonePlaceholder({
  ...
  return (
    <div
      className="flex flex-col items-center justify-center py-16 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-xl text-slate-400 dark:text-slate-500"
      onDragOver={(e) => {
        e.preventDefault();
        e.stopPropagation();
      }}
